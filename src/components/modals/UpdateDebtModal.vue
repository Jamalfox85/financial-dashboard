<template>
  <div class="modal-overlay-wrapper">
    ...
    >
      ...
      <span class="modal__title">Update Debt</span>
      <hr />
      ...
      <div class="modal__action">
        ...
        <button id="confirmModal" @click="submitDebtUpdate">Update</button>
      </div>
    </vue-final-modal>
  </div>
</template>
...
export default {
  ...
  methods: {
    submitDebtUpdate() {
      ...
      DebtDataService.update(this.id, data);
      this.closeModal();
    },
    closeModal() {
  ...
  watch: {
    showModal: {
      handler(newVal, oldVal) {
        this.debtName = this.title;
        this.debtAmount = this.debt;
        this.debtLimit = this.limit;
        this.debtCategory = this.category;
      },
    },
  },
};
